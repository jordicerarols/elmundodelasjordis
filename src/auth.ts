...
// Comparación en tiempo constante (sin early-exit que filtre la longitud de la
// contraseña por timing). Siempre recorre la cadena más larga, acumulando la
// diferencia de longitud en el resultado. En JS puro la constant-time perfecta
// no existe (JIT/GC), pero esto elimina la fuga obvia; suficiente para un login
// con un único secreto.
